...
def index(request):
    list_of_theme = [
        ...
        (
            'Marvel', 'Karantina,cursive',
            'https://fonts.googleapis.com / css2?family=Karantina:wght @ 300 & display=swap',
            'marvel_background.jpg', 'marvel_404.jpg', 'Personne ici', 'Retourner chasser le crime ailleurs.',
            'marvel_500.jpg',
            'Le cérébro à un problème', 'Attendez un moment pendant que nousle réparons.', "L'arsenal",
            'Welcome Avenger!',
            'Voici nos dernières découvertes:', 'Le crime ne dort jamais, querecherchez vous?',
            'Utiliser vos super-sens',
            'la patrouille', 'Cette ville est bien vide...', 'marvel_empty_street.jpg', '  # D8E3E7', '#51C4D3',
            '#126E82',
            '#132C33', '#D8E3E7')]
    games = Game.objects.all()

    for theme in list_of_theme:
        t = Theme.objects.create(name=theme[0], font_name=theme[2], font_link=theme[3], background_image=theme[4],
                                 image_404=theme[5],
                                 ...
                                 advanced_search_button_text=theme[15], query_name=theme[16],
                                 empty_query_text=theme[17],
